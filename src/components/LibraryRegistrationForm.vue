...
const validateReasonForJoinging = (blur) => { 
...
const showFriendMessage = computed(() => {
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        ...
        <p class="text-center">
          Let's bulid some more advanced features into our form.
        </p>
        <form @submit.prevent="submitForm">
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6">
              <label for="conform-password" class="form-label">Confirm Password</label>
              <input
                type="password"
                class="form-control"
                id="confirm-password"
